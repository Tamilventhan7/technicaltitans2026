...
exports.processLocalNLPQuery = processLocalNLPQuery;
const db_1 = require("../db");
async function processLocalNLPQuery(query) {
    ...
    const maintenanceLogs = await (0, db_1.getMaintenanceLogs)();
...
function warehousesCountActive(trips) {
    const hubs = new Set();
