...
export interface SimulationConfig {
  fuelPriceMultiplier: number; // e.g. 1.0 = normal
  orderVolumeSpike: number; // e.g. 0 = none, 20 = 20 extra orders
  activeDriversUnavailableCount: number; // e.g. how many drivers sick
